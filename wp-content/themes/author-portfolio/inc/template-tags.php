 ...
 */
if ( ! function_exists( 'author_portfolio_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function author_portfolio_posted_on($icon = false) {
...
function author_portfolio_post_page_navigation(){
	if (get_next_post_link() || get_previous_post_link()):
		?>
		<div class="d-flex single-post-navigation justify-content-between">
			<?php if (get_previous_post_link()): ?>
				<div class="previous-post">
					<div class="postarrow"><i class="fa fa-long-arrow-left"></i><?php echo esc_html_e( 'Previous Post', 'author-portfolio' ); ?></div>
			...
			?>
			<div class="next-post">
				<div class="postarrow"><?php echo esc_html_e( 'Next Post', 'author-portfolio' ); ?><i class="fa fa-long-arrow-right"></i></div>
...
function author_portfolio_postedby(){
	?>
...
function author_portfolio_theme_by(){
	?>
	<div class="theme-by-wrapper">
		<div class="theme-by-inner">
			<a class="display-only-icon" href="<?php echo esc_url('https://rswpthemes.com/author-portfolio-pro-wordpress-theme/');?>"><?php esc_html_e( 'Author Website Templates WordPress', 'author-portfolio' );?></a>
		</div>
	</div>
	<?php
}