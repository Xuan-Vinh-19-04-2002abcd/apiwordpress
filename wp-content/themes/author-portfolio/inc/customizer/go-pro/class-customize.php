 ...
 * @access public
 */
final class Author_Portfolio_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->register_section_type( 'Author_Portfolio_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new Author_Portfolio_Customize_Section_Pro(
				$manager,
				'go-pro',
				array(
					'priority'       => 1,
					'pro_text' => esc_html__( 'Upgrade To Pro', 'author-portfolio' ),
...
Author_Portfolio_Customize::get_instance();
