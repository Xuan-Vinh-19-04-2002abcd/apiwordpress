...
function author_portfolio_admin_enqueue_scripts(){
	wp_enqueue_script( 'author-portfolio-plugin-installer', get_theme_file_uri('/js/admin.js'), array( 'jquery' ), '', true );
    wp_localize_script( 'author-portfolio-plugin-installer', 'author_portfolio_ajax_object',
        array( 'ajax_url' => admin_url( 'admin-ajax.php' ) )
    );
}
add_action( 'admin_enqueue_scripts', 'author_portfolio_admin_enqueue_scripts' );

add_action( 'wp_ajax_install_act_plugin', 'author_portfolio_admin_install_plugin' );

function author_portfolio_admin_install_plugin() {
    /**
     * Install Plugin.
     */
