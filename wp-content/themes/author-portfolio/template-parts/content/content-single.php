...
$singlePostExtraClassess = 'author-portfolio-standard-post';
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( $singlePostExtraClassess ); ?>>
	<div class="author-portfolio-standard-post__entry-content text-left">
		<div class="author-portfolio-standard-post__post-meta-wrapper">
			...
			<div class="author-portfolio-standard-post__blog-meta<?php echo esc_attr($nolinebetweenmeta);?> pl-0">
				<?php
				...
				if (true == $s_post_el_is_on['show_post_comments']) :
					author_portfolio_comment_popuplink();
				endif;
				?>
			</div>
		</div>
			...
			<div class="author-portfolio-standard-post__content-inner">
				<div class="author-portfolio-standard-post__full-summery text-left">
					<?php
						...
						wp_link_pages(
							array(
								'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'author-portfolio' ),
								'after'  => '</div>',
							)
						);
					?>
