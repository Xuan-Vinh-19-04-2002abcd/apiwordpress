		...
		<div class="col-lg-6 col-md-7 pl-lg-5">
			<div class="book-info-wrapper">
				...
				<div class="book-author">
					<strong><?php esc_html_e( 'By: ', 'author-portfolio' );?></strong>
				...
				if(function_exists('rswpbs_get_book_price') && !empty(rswpbs_get_book_price(get_the_ID()))) : ?>
					<div class="book-price">
						<h5><strong><?php esc_html_e('Price: ', 'author-portfolio'); ?></strong><?php echo wp_kses_post( rswpbs_get_book_price(get_the_ID()) );?></h5>
					</div>
				<?php endif;
		...
		<div class="col-md-4">
			<div class="book-info-wrapper book-info-bg">
				...
				<div class="book-categories">
					<div class="d-flex">
						<div class="key">
							<strong><?php esc_html_e( 'Category: ', 'author-portfolio' );?></strong>
						</div>
						<div class="value">
							<p>
				...
				<div class="book-format">
					<div class="d-flex">
						<div class="key">
							<strong><?php esc_html_e( 'Format: ', 'author-portfolio' );?></strong>
						</div>
						<div class="value">
							<p>
				...
				<div class="book-publish-date">
					<div class="d-flex">
						<div class="key">
							<strong><?php esc_html_e( 'Publish Date: ', 'author-portfolio' );?></strong>
						</div>
						<div class="value">
							<p>
				...
				<div class="book-publisher-name">
					<div class="d-flex">
						<div class="key">
							<strong><?php esc_html_e( 'Publisher: ', 'author-portfolio' );?></strong>
						</div>
						<div class="value">
							<p>
				...
				<div class="book-isbn">
					<div class="d-flex">
						<div class="key">
							<strong><?php esc_html_e( 'ISBN: ', 'author-portfolio' );?></strong>
						</div>
						<div class="value">
							<p>
				...
				<div class="book-isbn-10">
					<div class="d-flex">
						<div class="key">
							<strong><?php esc_html_e( 'ISBN: -10 ', 'author-portfolio' );?></strong>
						</div>
						<div class="value">
							<p>
				...
				<div class="book-isbn-13">
					<div class="d-flex">
						<div class="key">
							<strong><?php esc_html_e( 'ISBN: -13', 'author-portfolio' );?></strong>
						</div>
						<div class="value">
							<p>
				...
				<div class="book-asin">
					<div class="d-flex">
						<div class="key">
							<strong><?php esc_html_e( 'ASIN: ', 'author-portfolio' );?></strong>
						</div>
						<div class="value">
							<p>
				...
				<div class="book-pages">
					<div class="d-flex">
						<div class="key">
							<strong><?php esc_html_e( 'Pages: ', 'author-portfolio' );?></strong>
						</div>
						<div class="value">
							<p>
				...
				<div class="book-country">
					<div class="d-flex">
						<div class="key">
							<strong><?php esc_html_e( 'Country: ', 'author-portfolio' );?></strong>
						</div>
						<div class="value">
							<p>
				...
				<div class="book-language">
					<div class="d-flex">
						<div class="key">
							<strong><?php esc_html_e( 'Language: ', 'author-portfolio' );?></strong>
						</div>
						<div class="value">
							<p>
				...
				<div class="book-translator">
					<div class="d-flex">
						<div class="key">
							<strong><?php esc_html_e( 'Translator: ', 'author-portfolio' );?></strong>
						</div>
						<div class="value">
							<p>
				...
				<div class="book-file-size">
					<div class="d-flex">
						<div class="key">
							<strong><?php esc_html_e( 'File:  Size', 'author-portfolio' );?></strong>
						</div>
						<div class="value">
							<p>
				...
				<div class="book-dimension">
					<div class="d-flex">
						<div class="key">
							<strong><?php esc_html_e( 'Dimension: ', 'author-portfolio' );?></strong>
						</div>
						<div class="value">
							<p>
				...
				<div class="book-weight">
					<div class="d-flex">
						<div class="key">
							<strong><?php esc_html_e( 'Weight: ', 'author-portfolio' );?></strong>
						</div>
						<div class="value">
							<p>
